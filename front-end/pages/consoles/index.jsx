...
import consolesList from "@/utils/consolesList";
...
const Consoles = () => {
  ...
  const getCategoryBrands = (category) => {
    const brands = {
      consoles: ["All", "sony", "microsoft", "nintendo"],
    };
  ...
  return (
    <Layout>
      <div
        style={{
          height: "60rem",
          backgroundImage: "url(/images/consoles-bg.png)",
      ...
      >
        <div className="font-akira relative top-[25rem] xl:text-7xl lg:text-7xl md:text-6xl sm:text-5xl xs:text-4xl text-white tracking-widest uppercase scale-y-90 text-center space-y-5 leading-tight">
          <h1>{category}</h1>
          <h1
            style={{
      ...
      <div className="px-16 mt-16 mb-32">
        ...
        <div
          className="flex xl:justify-evenly lg:justify-evenly md:justify-evenly sm:justify-evenly xs:justify-center items-center flex-wrap gap-y-8"
          ref={containerRef}
        >
          {filteredProducts
            .slice()
