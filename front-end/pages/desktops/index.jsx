...
import desktopsList from "@/utils/desktopsList";
...
const Desktops = () => {
  ...
  const category = "desktops";

  const getCategoryBrands = (category) => {
    const brands = {
      desktops: ["All", "skytech", "zotac", "msi", "ibuypower", "hp"],
    };
  ...
  return (
    <Layout>
      <div
        style={{
          height: "60rem",
          backgroundImage: "url(/images/desktops-bg.png)",
      ...
      <div className="px-16 mt-16 mb-32">
        ...
        <div
          className="flex xl:justify-evenly lg:justify-evenly md:justify-evenly sm:justify-evenly xs:justify-center items-center flex-wrap gap-y-14 gap-x-16 text-center"
          ref={containerRef}
        >
          {filteredProducts
            .slice()
            ...
            .map((product) => (
              <div
                key={product.slug}
                className="flex flex-col xl:w-[400px] lg:w-[350px] md:w-[300px] sm:w-[300px] xs:w-[250px] rounded-3xl"
              >
                ...
                <div className="flex flex-col text-white justify-center items-center space-y-1">
